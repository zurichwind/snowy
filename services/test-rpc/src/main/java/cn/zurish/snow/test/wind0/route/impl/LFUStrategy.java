...
public class LFUStrategy extends SnowRpcLoadBalance {

    private final ConcurrentMap<String, HashMap<String, Integer>> jobLfuMap = new ConcurrentHashMap<String, HashMap<String, Integer>>();

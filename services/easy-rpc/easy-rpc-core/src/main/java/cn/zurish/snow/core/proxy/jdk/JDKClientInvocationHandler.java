...
import static cn.zurish.snow.core.common.cache.CommonClientCache.SEND_QUEUE;
import static cn.zurish.snow.core.common.constants.RpcConstants.DEFAULT_TIMEOUT;
...
public class JDKClientInvocationHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        while (System.currentTimeMillis() - beginTime < timeOut || rpcInvocation.getRetry() > 0) {
            ...
            if (object instanceof RpcInvocation rpcInvocationResp) {
                //异常结果+有重试次数=异常重试
